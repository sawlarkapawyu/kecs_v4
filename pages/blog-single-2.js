            ...
            <Layout>
                <section className="pb-20">
                    ...
                    <div className="container">
                        ...
                        <div className="pt-40 pb-40 mb-12 bg-cover bg-no-repeat bg-center rounded-xl" style={{ backgroundImage: "url('assets/imgs/placeholders/img-8.png')" }}>
                            <div className="max-w-2xl mx-auto">
                        ...
                        <div className="max-w-2xl mx-auto">
                            ...
                            <a href="#" target="_blank" className="inline-flex items-center text-gray-600 dark:text-gray-200 hover:underline mt-8">
