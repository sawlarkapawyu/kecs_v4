            ...
            <Layout>
                            ...
                            <div className="w-full px-3 lg:w-1/2">
                                <div className="py-12">
                                    <div className="max-w-lg mx-auto mb-8 text-center lg:max-w-md lg:mx-0 lg:text-left">
                                        ...
                                        <div className="leading-relaxed text-blueGray-400 wow animate__animated animate__fadeIn">
                                        ...
                                        <p className="mt-3 text-sm leading-relaxed text-blueGray-400 wow animate__animated animate__fadeIn">Helping you maximize operations management with digitization</p>
                                    </div>
                                    <div className="text-center lg:text-left">
                                        <a className="block px-8 py-4 mb-4 text-xs font-semibold leading-none tracking-wide text-center text-white bg-blue-400 rounded hover-up-2 sm:inline-block sm:mb-0 sm:mr-3 hover:bg-blue-500 wow animate__animated animate__fadeIn" href="#key-features">
                                            Key Features
                                        </a>
                                        <a className="block px-8 py-4 text-xs font-semibold leading-none text-center bg-white border rounded hover-up-2 sm:inline-block text-blueGray-500 hover:text-blueGray-600 border-blueGray-200 hover:border-blueGray-300 wow animate__animated animate__fadeIn" data-wow-delay=".3s" href="#how-we-work">
                                            How We Work?
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div className="container">
                        <div className="flex flex-wrap items-center mb-12">
                            ...
                            <div className="w-full lg:w-1/2">
                                <p className="leading-loose lg:pl-16 text-blueGray-400 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                        ...
                        <div className="flex flex-wrap -mx-3 -mb-6">
                            ...
                            <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/4">
                                <div className="px-6 pt-8 pb-6 text-center transition duration-500 bg-white border border-gray-100 rounded shadow hover:shadow-lg hover-up-2 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    <div className="mx-auto mb-4 text-blue-500">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/4">
                                <div className="px-6 pt-8 pb-6 text-center transition duration-500 bg-white border border-gray-100 rounded shadow hover:shadow-lg hover-up-2 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                    <div className="mx-auto mb-4 text-blue-500">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/4">
                                <div className="px-6 pt-8 pb-6 text-center transition duration-500 bg-white border border-gray-100 rounded shadow hover:shadow-lg hover-up-2 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                    <div className="mx-auto mb-4 text-blue-500">
                                        <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-wrap -mx-8">
                            <div className="w-full px-8 lg:w-1/2">
                                <div className="pb-12 mb-12 border-b lg:mb-0 lg:pb-0 lg:border-b-0">
                                    <h2 className="max-w-md mb-4 text-3xl font-bold lg:text-4xl font-heading wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <Link href="/services" legacyBehavior>
                                        <a className="inline-block px-8 py-4 text-xs font-semibold leading-none text-white bg-blue-400 rounded hover:bg-blue-500 hover-up-2 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                            Learn More
                                        </a>
                                    </Link>
                                </div>
                            ...
                            <div className="w-full px-8 lg:w-1/2">
                                <ul className="space-y-12">
                                    <li className="flex -mx-4 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                        <div className="px-4">
                                            <span className="flex items-center justify-center w-16 h-16 mx-auto text-2xl font-bold text-blue-600 rounded-full font-heading bg-blue-50">1</span>
                                        </div>
                                        <div className="px-4">
                                            <h3 className="my-4 text-xl font-semibold">Project Initialization</h3>
                                            <p className="leading-loose text-blueGray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus eget justo et iaculis.</p>
                                        </div>
                                    </li>
                                    <li className="flex -mx-4 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                        <div className="px-4">
                                            <span className="flex items-center justify-center w-16 h-16 mx-auto text-2xl font-bold text-blue-600 rounded-full font-heading bg-blue-50">2</span>
                                        </div>
                                        <div className="px-4">
                                    ...
                                    <li className="flex -mx-4 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                        <div className="px-4">
                                            <span className="flex items-center justify-center w-16 h-16 mx-auto text-2xl font-bold text-blue-600 rounded-full font-heading bg-blue-50">3</span>
                                        </div>
                                        <div className="px-4">
                ...
                <section className="py-12 md:py-20">
                    <div className="container">
                        <div className="flex flex-wrap -mx-3">
                            <div className="relative w-full mb-8 text-center lg:w-1/3 lg:mb-0 lg:text-left">
                                <div className="max-w-md mx-auto mb-6 lg:max-w-xs lg:ml-0 lg:mb-0">
                                    <h2 className="mb-4 text-3xl font-bold md:text-4xl font-heading wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
                                        Simple Solution for <span className="text-blue-500">Complex</span> Connections
                                    </h2>
                                    <p className="text-xs leading-loose md:text-base text-blueGray-400 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus eget justo et iaculis.
                                    </p>
                                </div>
                                <div className="flex justify-center lg:absolute lg:bottom-0 lg:left-0 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    <div id="carausel-fade-1-arrows" className="flex"></div>
                                </div>
                            </div>
                            <div className="flex flex-wrap w-full px-3 lg:w-2/3 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <div className="relative w-full rounded">
                                    <div className="rounded carausel-fade slick-carausel" id="carausel-fade-1">
                                        <Slider2 />
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-20 bg-top bg-no-repeat xl:bg-contain" style={{ backgroundImage: "url('assets/imgs/backgrounds/intersect.svg')" }}>
                    <div className="container">
                        ...
                        <div className="flex flex-wrap mb-10 sm:justify-center">
                            <label className="flex items-center mb-2 mr-8 wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
                                <input type="radio" name="billing" value="1" />
                                <span className="mx-2 font-semibold">Monthly Billing</span>
                                <span className="inline-flex items-center justify-center w-12 h-10 font-semibold text-white bg-blue-500 rounded">$59</span>
                            </label>
                            <label className="flex items-center mb-2 wow animate__animated animate__fadeIn animated" data-wow-delay=".5s">
                                ...
                                <span className="inline-flex items-center justify-center w-12 h-10 font-semibold text-white bg-blue-500 rounded">$99</span>
                            </label>
                        </div>
                        <div className="flex flex-wrap bg-white rounded shadow wow animate__animated animate__fadeIn animated">
                            <div className="w-full px-3 md:w-1/2 lg:w-2/5">
                                <div className="p-8 text-center">
                                    ...
                                    <div className="flex px-4 mb-4 rounded bg-blueGray-100">
                                        <input className="w-full py-4 text-xs font-semibold leading-none border-transparent outline-none placeholder-blueGray-400 bg-blueGray-100 focus:border-blue-500" type="email" placeholder="name@email.com" />
                                    ...
                                    <div className="flex px-4 mb-6 rounded bg-blueGray-100">
                                        <input className="w-full py-4 text-xs font-semibold leading-none border-transparent outline-none placeholder-blueGray-400 bg-blueGray-100 focus:border-blue-500" type="password" placeholder="Enter your password" />
                                    ...
                                    <div className="mb-5 text-sm text-left text-blueGray-400">
                                        <label>
                                            <input type="checkbox" name="terms" value="1" />
                                            <span className="ml-1">I agree to terms and conditions.</span>
                                        </label>
                                    </div>
                                    <button className="block w-full p-4 text-xs font-semibold leading-none text-center text-white bg-blue-400 rounded hover:bg-blue-500">Purchase now</button>
                                </div>
                            </div>
                            <div className="relative w-full px-3 overflow-hidden bg-blue-500 rounded-r md:w-1/2 lg:w-3/5">
                                <div className="max-w-sm px-12 pt-12">
                                    <span className="text-xs text-blue-200">Various Analysis Options</span>
                                    <h3 className="mb-4 text-4xl font-bold text-white font-heading">Techno Provides Realtime Best Data Solutions.</h3>
                                </div>
                        ...
                        <div className="max-w-2xl mx-auto lg:max-w-3xl">
                            ...
                            <div className="flex flex-wrap -mx-3 text-center">
                                <div className="w-1/2 px-3 mb-12 lg:w-1/3 wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
                                    <svg className="w-8 h-8 mx-auto mb-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                <form>
                                    ...
                                    <div className="flex flex-wrap mb-4 -mx-3 wow animate__animated animate__fadeIn animated" data-wow-delay=".3s">
                                        <div className="w-full px-3 mb-4 lg:w-1/2 lg:mb-0">
                                            <div className="mb-4">
                                        ...
                                        <div className="w-full px-3 lg:w-1/2">
                                            <textarea className="w-full h-full p-4 text-xs font-semibold leading-none border-transparent rounded outline-none resize-none bg-blueGray-50 focus:border-blue-500" placeholder="Message..."></textarea>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button className="px-8 py-4 text-sm font-semibold leading-none text-white bg-blue-400 rounded hover:bg-blue-500" type="submit">
                                            Submit
                                        </button>
                                    </div>
                                </form>
