                                    ...
                                    <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                                        ...
                                        <div className="border-t border-gray-100">
                                            <dl className="divide-y divide-gray-100">
                                                ...
                                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                                    <dt className="text-sm font-medium leading-6 text-gray-900">Shareholder List</dt>
                                                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                        {shareholders.map((shareholder, index) => (
                                                        <div key={index}>
                                                ...
                                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                                    <dt className="text-sm font-medium leading-6 text-gray-900">Business List</dt>
                                                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                        {businesses.map((business, index) => (
                                                        <div key={index}>
                                                        ...
                                                        <ul role="list" className="border border-gray-200 divide-y divide-gray-100 rounded-md">
                                                            ...
                                                            <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                                                <div className="flex items-center flex-1 w-0">
                                                                    ...
                                                                    <div className="flex flex-1 min-w-0 gap-2 ml-4">
                                                                    <span className="font-medium truncate">{docUrls.doc2 && ( <p>{docUrls.doc2}</p> )}</span>
                                                                    </div>
                                                                </div>
                                                                <div className="flex-shrink-0 ml-4">
                                                                    {docUrls.doc2 && (
                                                            ...
                                                            <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                                                <div className="flex items-center flex-1 w-0">
                                                                    ...
                                                                    <div className="flex flex-1 min-w-0 gap-2 ml-4">
                                                                    <span className="font-medium truncate">{docUrls.doc3 && ( <p>{docUrls.doc3}</p> )}</span>
                                                                    </div>
                                                                </div>
                                                                <div className="flex-shrink-0 ml-4">
                                                                    {docUrls.doc3 && (
