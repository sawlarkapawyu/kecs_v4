...
export default function RegistrationForm({ businessId }) {
    ...
    const handleViewSignature = async (signature) => {
        ...
        newWindow.document.write(`<img src="${fileURL}" alt="${signature}" />`);
        } catch (error) {
        console.log('error downloading', error);
        }
    };
    
    // Handle download Signature
    const handleDownloadSignature = async (signature) => {
        try {
        const { data, error } = await supabase.storage
            .from('applicant_signature')
            .download(signature);
        ...
        // Create a temporary URL that points to the blob object
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="px-2 py-2">
                                <label htmlFor="info-correct">
                                    ...
                                    required
                                    />
                                    &nbsp; &nbsp; Information is correct and checked.
                                </label>
                            </div>
                            <div className="px-2 py-2">
